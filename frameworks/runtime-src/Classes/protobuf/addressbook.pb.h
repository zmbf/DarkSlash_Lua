...
class Data : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Data) */ {
 public:
  ...
  // .tutorial.Data.Person persons = 2;
  bool has_persons() const;
  void clear_persons();
  static const int kPersonsFieldNumber = 2;
  const ::tutorial::Data_Person& persons() const;
  ::tutorial::Data_Person* release_persons();
  ::tutorial::Data_Person* mutable_persons();
  void set_allocated_persons(::tutorial::Data_Person* persons);
...
// .tutorial.Data.Person persons = 2;
inline bool Data::has_persons() const {
  return this != internal_default_instance() && persons_ != NULL;
}
inline void Data::clear_persons() {
  if (GetArenaNoVirtual() == NULL && persons_ != NULL) {
    delete persons_;
  }
  persons_ = NULL;
}
inline const ::tutorial::Data_Person& Data::persons() const {
  const ::tutorial::Data_Person* p = persons_;
  // @@protoc_insertion_point(field_get:tutorial.Data.persons)
  return p != NULL ? *p : *reinterpret_cast<const ::tutorial::Data_Person*>(
      &::tutorial::_Data_Person_default_instance_);
}
inline ::tutorial::Data_Person* Data::release_persons() {
  // @@protoc_insertion_point(field_release:tutorial.Data.persons)
  
  ::tutorial::Data_Person* temp = persons_;
  persons_ = NULL;
  return temp;
}
inline ::tutorial::Data_Person* Data::mutable_persons() {
  
  if (persons_ == NULL) {
    persons_ = new ::tutorial::Data_Person;
  }
  // @@protoc_insertion_point(field_mutable:tutorial.Data.persons)
  return persons_;
}
inline void Data::set_allocated_persons(::tutorial::Data_Person* persons) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
    delete persons_;
  }
  if (persons) {
    ::google::protobuf::Arena* submessage_arena = NULL;
    if (message_arena != submessage_arena) {
      persons = ::google::protobuf::internal::GetOwnedMessage(
  ...
  persons_ = persons;
  // @@protoc_insertion_point(field_set_allocated:tutorial.Data.persons)
}
